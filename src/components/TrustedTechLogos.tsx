    ...
    <section ref={ref} className="relative overflow-hidden">
      <div className="py-3 border-t border-border/30">
            ...
            {[...techPartners, ...techPartners, ...techPartners].map(
              (name, index) => (
                <div key={index} className="flex-shrink-0 mx-8 flex items-center gap-2">
                  <span className="text-xs font-bold text-foreground/40 whitespace-nowrap tracking-widest uppercase">
                    {name}
                  </span>
                </div>
              ),
        ...
        <div className="text-center mt-2">
          <p className="text-[11px] text-muted-foreground tracking-widest uppercase flex items-center justify-center gap-1.5">
