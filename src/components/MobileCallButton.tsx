...
const MobileCallButton = forwardRef<HTMLAnchorElement>((_props, ref) => {
  return (
    <a
      ref={ref}
      href={SITE.phone.tel}
      className="gx-fab fixed bottom-4 left-1/2 -translate-x-1/2 z-fab md:hidden flex items-center justify-center gap-2 py-2.5 px-4 rounded-full font-semibold text-sm text-white bg-gradient-to-br from-[#e07b52] to-[#d96c4a] shadow-lg"
