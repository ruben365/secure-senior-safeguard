...
const ScrollIndicator = () => {
  ...
  return (
    <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-30 animate-smooth-bounce">
      <button
      ...
      >
        ...
        <div className="w-5 h-5 rounded-full border-2 border-white/50 hover:border-white flex items-center justify-center transition-colors duration-300">
