              ...
              <div className="pt-4 pb-2 flex flex-col items-center gap-2">
                {isAdminOrStaff ? (
                  ...
                  <Link
                    to="/portal"
                    onClick={() => setMobileMenuOpen(false)}
                    className="inline-flex items-center h-[34px] px-5 text-[12px] font-semibold rounded-full text-white bg-gradient-to-b from-[#c2410c] to-[#9a3412] border border-[#7c2d12] shadow-[0_1px_0_0_rgba(255,255,255,0.18)_inset,0_8px_20px_-6px_rgba(217,108,74,0.5)] hover:-translate-y-[1px] hover:from-[#ea580c] hover:to-[#c2410c] active:translate-y-[0.5px] transition-all duration-200"
                  >
                    Login
                  </Link>
                )}
