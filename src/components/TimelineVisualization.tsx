    ...
    <div className="relative py-8">
      ...
      <div className="space-y-16 md:space-y-20">
        {events.map((event, index) => (
          <ScrollReveal key={event.year} delay={index * 100} animation="fade-up">
            <div className={`relative flex items-center ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
              ...
              <Card className={`ml-20 md:ml-0 ${index % 2 === 0 ? 'md:mr-[calc(50%+4rem)]' : 'md:ml-[calc(50%+4rem)]'} p-8 hover:shadow-xl hover:scale-[1.02] transition-all duration-500 border-2 border-border/50 hover:border-primary/30 bg-gradient-to-br from-background to-secondary/20`}>
                <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-foreground mb-3 leading-tight">{event.title}</h3>
