...
export const CompellingCTA = ({ variant = 'primary', className = '' }: CompellingCTAProps) => {
        ...
        <div className="center-container-narrow">
          <AnimatedSection animation="scale-up">
            <div className="text-center text-white">
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/20 backdrop-blur-sm mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Button
                  asChild
                  size="lg"
                  className="h-14 px-10 text-base font-bold rounded-full bg-white text-primary hover:bg-white/90 shadow-xl"
                >
                  <Link to="/training#pricing">
                    Claim Free Month <ArrowRight className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="h-14 px-10 text-base font-bold rounded-full border-2 border-white text-white hover:bg-white/10"
                >
                  <Link to="/contact">
      ...
      <section className={`section-padding-lg bg-muted/30 ${className}`}>
        <div className="center-container">
          <AnimatedSection animation="fade-up">
            <div className="glass-card rounded-3xl card-padding-xl max-w-4xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  ...
                  <Button
                    asChild
                    size="lg"
                    className="h-14 px-10 text-base font-bold rounded-full bg-gradient-to-r from-primary to-accent text-white"
                  >
                    <Link to="/contact">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={stat.label}
                      className="glass-widget rounded-2xl p-6 flex items-center gap-4"
                    >
                      <div className="text-4xl font-black text-primary">
                        {stat.number}
                        {stat.unit && <span className="text-2xl text-muted-foreground">{stat.unit}</span>}
                      </div>
  ...
  return (
    <section className={`section-padding-xl bg-gradient-to-b from-background to-muted/50 ${className}`}>
      <div className="center-container-narrow">
        <AnimatedSection animation="scale-up">
          <div className="glass-heavy rounded-3xl card-padding-xl text-center specular-highlight">
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full glass-widget mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button
                asChild
                size="lg"
                className="h-16 px-12 text-lg font-bold rounded-full bg-gradient-to-r from-primary to-accent text-white hover:opacity-90 shadow-xl hover:shadow-2xl transition-all hover:scale-105"
              >
                <Link to="/training#pricing">
                  Get Protected Now <ArrowRight className="ml-2 w-6 h-6" />
                </Link>
              </Button>
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-16 px-12 text-lg font-bold rounded-full border-2"
              >
                <Link to="/contact">
                  Talk to Our Team
                </Link>
