  ...
  return (
    <section className="py-12 lg:py-16" ref={containerRef}>
      <div className="container mx-auto px-4 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(268 48% 10%) 0%, hsl(268 42% 14%) 35%, hsl(300 32% 12%) 65%, hsl(268 48% 8%) 100%)' }}>
          {/* Glassmorphism orbs */}
