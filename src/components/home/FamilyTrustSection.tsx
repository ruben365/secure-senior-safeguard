...
export const FamilyTrustSection = () => {
  return (
    <section className="py-6 lg:py-8 bg-gradient-to-br from-background via-lavender-50/20 to-coral-50/15 dynamic-gradient-overlay" aria-labelledby="trust-heading">
