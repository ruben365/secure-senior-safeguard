    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="h-20 bg-[#111827] border border-gray-800 rounded-lg p-4 space-y-3"
          >
      ...
      {[...Array(6)].map((_, i) => (
        ...
        >
          ...
          <div className="flex gap-2 pt-2">
            <div className="h-5 flex-1 bg-gray-700 rounded" />
            <div className="h-5 flex-1 bg-gray-700 rounded" />
          </div>
        </div>
      ))}
...
function FormSkeleton() {
  return (
    <div className="max-w-2xl mx-auto bg-[#111827] border border-gray-800 rounded-lg p-5 space-y-4">
      {[...Array(5)].map((_, i) => (
...
export function StatCardSkeleton() {
  return (
    <div className="h-20 bg-[#111827] border border-gray-800 rounded-lg p-4 space-y-3">
      <div className="flex items-center justify-between">
        <div className="h-4 w-12 bg-gray-700 rounded" />
        <div className="h-6 w-6 bg-gray-700 rounded" />
      </div>
