      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="cursor-pointer hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Click to view services</p>
          </CardContent>
        </Card>
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${client.unpaidInvoices === 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <a href={`mailto:${client.contactEmail}`} className="text-base text-primary hover:underline">
                {client.contactEmail}
              </a>
            </div>
            <div>
              <label className="text-sm font-medium text-muted-foreground">Phone</label>
              <a href={`tel:${client.contactPhone}`} className="text-base text-primary hover:underline">
                {client.contactPhone}
              </a>
            </div>
            <div>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-base">{client.status.charAt(0).toUpperCase() + client.status.slice(1)} since {client.joinDate}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-muted-foreground">Last Activity</label>
              <p className="text-base">{client.lastActivity} (logged into portal)</p>
            </div>
            <div>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { icon: "💰", text: "Invoice #2045 paid ($149)", time: "yesterday" },
              { icon: "🎫", text: "Support ticket opened", time: "3 days ago" },
              { icon: "✨", text: "New service activated: AI Insurance", time: "1 week ago" },
            ].map((activity, index) => (
