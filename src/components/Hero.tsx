...
interface HeroProps {
  ...
  /** Use a lighter, warmer overlay for human-centric images */
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Premium Gradient Overlay - enhanced for text visibility */}
        {!disablePurpleOverlay && (
          <>
            {lightOverlay ? (
              // Light, warm overlay for human-centric images
              <>
                {/* Soft white gradient from left for text readability */}
                <div 
                  className="absolute inset-0 pointer-events-none"
                  style={{
                    background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.6) 0%, rgba(30, 41, 59, 0.4) 30%, transparent 60%)'
                  }}
                />
                
                {/* Subtle bottom gradient for content */}
                <div 
                  className="absolute inset-0 pointer-events-none"
                  style={{
                ...
                {/* Light accent for brand colors */}
                <div 
                  className="absolute inset-0 pointer-events-none opacity-20"
                  style={{
                    background: 'linear-gradient(135deg, rgba(88, 28, 135, 0.3) 0%, transparent 50%)'
                  }}
                />
              </>
            ) : (
              // Standard purple overlay
              <>
