    ...
    return (
      <div className="floating-label-container">
        <input
          ref={ref}
          className={cn(
            "flex h-7 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-transparent disabled:cursor-not-allowed disabled:opacity-50",
