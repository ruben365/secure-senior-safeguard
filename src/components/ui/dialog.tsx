...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="gx-dialog-close absolute right-2.5 top-2.5 rounded-full p-1.5 min-w-[32px] min-h-[32px] flex items-center justify-center text-[rgba(255,255,255,0.5)] transition-all hover:text-[rgba(255,255,255,0.9)] hover:bg-[rgba(255,255,255,0.1)] focus:outline-none focus:ring-2 focus:ring-white/20 disabled:pointer-events-none">
        <X className="h-4 w-4" />
