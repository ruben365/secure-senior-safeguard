...
// IMPORTANT: Replace stripePriceId values with your new Stripe price IDs after
// creating them in the Stripe dashboard at the prices listed below.
// Old plans ($39/$79/$129) have been replaced with new tiers ($9.99/$19.99/$29.99).
export const SCAMSHIELD_PLANS: Product[] = [
  {
    id: "scamshield-basic",
    name: "ScamShield Basic",
    description: "Essential AI scam protection for individuals — stop scams before they cost you",
    category: "scamshield",
    paymentType: "subscription",
    // TODO: Replace with $9.99/mo Stripe price ID (create at dashboard.stripe.com/prices)
  ...
  },
  {
    id: "scamshield-pro",
    name: "ScamShield Pro",
    description: "Advanced protection with priority scanning, alerts, and training discounts",
    category: "scamshield",
    paymentType: "subscription",
    // TODO: Replace with $19.99/mo Stripe price ID (create at dashboard.stripe.com/prices)
  ...
  },
  {
    ...
    description: "Unlimited protection with dedicated support and family/business coverage",
    category: "scamshield",
    paymentType: "subscription",
    // TODO: Replace with $29.99/mo Stripe price ID (create at dashboard.stripe.com/prices)
    stripePriceId: "price_1SjwULJ8osfwYbX7DdZ4Ckqc",
    stripeProductId: "prod_SWvDVhZEzl3Fft",
    price: 29.99,
    billingInterval: "month",
    features: [
      "Unlimited scans + deepScan mode",
      "Dedicated account manager",
      "Custom security audits & API access",
      "All training courses included",
      "Priority phone support",
      "Family & business coverage (up to 5)",
    ],
    popular: false,
  },
];
