    ...
    <PageTransition variant="fade">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {companyValues.map((value, index) => {
              ...
              return (
                <div key={index} className="rounded-2xl border border-white/[0.06] bg-[#111118] p-6 text-center hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-20 bg-[#08080e]">
        <div className="container mx-auto px-4">
          ...
          <Card className="mt-12 max-w-3xl mx-auto overflow-hidden border-white/[0.06] bg-[#111118]">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {benefits.map((category, index) => (
              <div key={index} className="rounded-2xl border border-white/[0.06] bg-[#111118] p-6 hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="grid md:grid-cols-4 gap-5 max-w-5xl mx-auto">
            {applicationSteps.map((step, index) => (
              <div key={index} className="relative">
                <div className="rounded-2xl border border-white/[0.06] bg-[#111118] text-center p-6 h-full hover:-translate-y-1 transition-all duration-300">
                  <div className="w-14 h-14 rounded-2xl bg-primary text-white flex items-center justify-center mx-auto mb-4 text-xl font-black">
                    {step.step}
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-6 max-w-6xl mx-auto mb-12">
            <div className="relative rounded-2xl overflow-hidden group border border-white/[0.06]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <p className="text-white/70 text-sm">Ideas flow freely in our open environment</p>
              </div>
            </div>
            <div className="relative rounded-2xl overflow-hidden group border border-white/[0.06]">
              <img
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <p className="text-white/70 text-sm">We genuinely care about every customer</p>
              </div>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="rounded-2xl border border-white/[0.06] bg-[#111118] text-center p-6 hover:-translate-y-1 transition-all duration-300">
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
