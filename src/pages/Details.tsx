...
const Details = () => {
  ...
  return (
    <div className="min-h-screen pt-28 pb-20 relative overflow-hidden gradient-mesh">
      <div className="floating-blob w-[400px] h-[400px] bg-accent/20 top-10 left-[-100px]" />
      <div className="floating-blob w-[350px] h-[350px] bg-primary/12 bottom-20 right-[-80px]" />
