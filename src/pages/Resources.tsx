    ...
    <PageTransition variant="fade">
      ...
      <section id="guides" className="py-16 md:py-24 bg-muted/20 relative overflow-hidden">
        <div className="container mx-auto">
          ...
          <div className="gx-gallery grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 2000px' }}>
