...
// Pro components removed for cleaner dark theme
...
function About() {
  ...
  return (
    <PageTransition variant="fade">
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="xl" asChild className="bg-primary hover:bg-primary/90 text-primary-foreground">
      ...
      {/* Our Story */}
      <section className="py-10 sm:py-16 md:py-20 bg-[#0a0a0f] relative overflow-hidden">
        <div className="container mx-auto px-4 lg:px-12">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <span className="inline-block text-[11px] uppercase tracking-[0.15em] font-semibold text-primary bg-primary/10 px-4 py-1.5 rounded-full mb-4">
                Our Story
              </span>
      ...
      {/* Timeline */}
      <section className="py-10 sm:py-16 md:py-20 bg-[#111118] relative overflow-hidden">
        <div className="container mx-auto px-4 lg:px-12">
      ...
      {/* Founders */}
      <section id="founders" className="py-10 sm:py-16 md:py-20 bg-[#0a0a0f] relative overflow-hidden">
        <div className="container mx-auto px-4 lg:px-12">
          <div className="text-center mb-14">
            <span className="inline-block text-[11px] uppercase tracking-[0.15em] font-semibold text-primary bg-primary/10 px-4 py-1.5 rounded-full mb-4">
              Meet Our Founders
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            <Card className="p-6 sm:p-8 border border-white/[0.06] bg-[#111118] shadow-sm hover:border-primary/20 transition-all duration-300">
              <div className="relative mb-6">
                <div className="w-full aspect-square bg-[#0a0a0f] rounded-xl flex items-center justify-center border border-white/[0.06]">
              ...
              <h3 className="text-2xl font-bold mb-2 text-white">Ruben</h3>
              ...
              <blockquote className="border-l-4 border-primary pl-4 italic text-sm text-white/60">
            ...
            <Card className="p-6 sm:p-8 border border-white/[0.06] bg-[#111118] shadow-sm hover:border-primary/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-2 text-white">Corine</h3>
              <p className="text-sm text-white/70 mb-4 leading-relaxed">
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-[#111118]">
        <div className="container mx-auto px-4 lg:px-12">
          <div className="text-center mb-14">
            <span className="inline-block text-[11px] uppercase tracking-[0.15em] font-semibold text-primary bg-primary/10 px-4 py-1.5 rounded-full mb-4">Our Values</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {values.map((value) => {
              ...
              return (
                <div key={value.title} className="text-center h-full p-6 rounded-2xl bg-[#0a0a0f] border border-white/[0.06] hover:border-primary/20 transition-all duration-300">
        ...
        <div className="container mx-auto px-4 lg:px-12 relative z-10 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={item.title} className="bg-white/[0.05] border border-white/[0.08] rounded-2xl p-6 text-center transition-all duration-300 hover:border-primary/20">
      ...
      <section className="py-10 sm:py-16 md:py-20 bg-[#0a0a0f]">
        <div className="container mx-auto px-4 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="relative group overflow-hidden rounded-2xl border border-white/[0.06]">
              <img
                src={familyGathering}
