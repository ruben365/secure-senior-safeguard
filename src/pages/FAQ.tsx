...
// Aligned with the three core services: AI, Education,
...
const faqs: FAQEntry[] = [
  ...
  // ══════════════════════════════════════════════════════════
  {
    id: "ai-1",
    category: "AI Systems",
    question: "What's included in your AI systems?",
    answer:
  ...
  return (
    <PageTransition variant="fade">
      <SEO
        ...
        description="Answers about InVision Network's AI systems, cybersecurity education workshops, AI insurance plans, billing, and privacy — straight from our Kettering, Ohio team."
      ...
      <main>
        ...
        <div className="relative">
          <Hero
            ...
            subheadline="Clear answers about our AI systems, workshops, and support — no jargon, no runaround."
            overlay={true}
        ...
        <section
          ...
          className="premium-section-shell relative isolate py-12 md:py-16 overflow-hidden"
        >
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-[12px] text-slate-600 mb-3 ml-10">
                        ...
                        Kettering. Or explore our <Link to="/training" className="text-primary hover:underline font-medium">training sessions</Link> and <Link to="/ai" className="text-primary hover:underline font-medium">AI systems</Link>.
                      </p>
