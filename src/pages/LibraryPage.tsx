...
function LibraryLanding() {
  return (
    <div className="flex-1">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#fff8f5] via-background to-[#fdf6f2]/60 border-b pt-[clamp(100px,14vw,140px)] pb-16">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-10 w-80 h-80 rounded-full bg-primary/10 blur-3xl" />
          <div className="absolute bottom-0 left-10 w-64 h-64 rounded-full bg-accent/10 blur-3xl" />
        </div>
        <div className="container mx-auto max-w-4xl text-center relative">
          <Badge className="mb-5 bg-primary/10 text-primary border-primary/20 px-4 py-1.5 text-sm">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-5 leading-tight">
            ...
            <span className="text-primary">for Every Family</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="gap-2 text-base h-12">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Featured Titles</h2>
              ...
              <div key={book.slug} className="group relative">
                <Card className="h-full overflow-hidden border-border/60">
                  ...
                  <CardContent className="p-4">
                    ...
                    <p className="text-xs text-muted-foreground line-clamp-2 mb-3">{book.subtitle}</p>
      ...
      {/* Why our library */}
      <section className="py-16 bg-[#fff8f5] border-t">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Why InVision Library?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={title} className="p-6 border-border/50">
...
function BookCard({ book, isPurchased, onBuyClick, onReadClick }: BookCardProps) {
  return (
    <Card className={cn(
      "h-full flex flex-col overflow-hidden border-border/60 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5",
      isPurchased && "ring-2 ring-green-500/30 border-green-500/20"
    )}>
      {/* Cover */}
          ...
          {isPurchased ? (
            ...
            <>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Button size="sm" className="h-7 text-xs gap-1" onClick={() => onBuyClick(book)}>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main id="main-content" tabIndex={-1} className="flex-1">
        {/* ── Page header ── */}
        <section className="bg-gradient-to-br from-[#fff8f5] via-background to-[#fdf6f2]/50 border-b pt-[clamp(80px,12vw,120px)] pb-10">
          <div className="container mx-auto max-w-6xl">
