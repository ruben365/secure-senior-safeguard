...
const SectionHeader = ({
  ...
  <AnimatedSection animation="fade-up" className="text-center mb-9">
    ...
    <h2 className="text-3xl md:text-2xl font-black mb-4 leading-tight">{title}</h2>
    {subtitle && (
    ...
    <div className="p-5 flex flex-col flex-1">
      <div className="mb-4 mt-1">
        ...
        <div className="flex items-baseline gap-1 mb-2">
          <span className="text-3xl font-black tracking-tight" style={highlight ? { color: '#f5c543' } : {}}>
            {price}
          </span>
      ...
      {highlight ? (
        <button
          onClick={onClick}
          className="w-full h-7 font-bold rounded-xl transition-all duration-200 hover:opacity-90"
          style={{
        ...
        <Button onClick={onClick} className="w-full h-7 font-bold rounded-xl" variant="outline">
          {cta}
        </Button>
      )}
    </div>
        ...
        <main>
          ...
          <section className="relative overflow-hidden min-h-[100dvh] flex items-center pt-[clamp(100px,14vw,140px)] pb-6 bg-gradient-to-br from-[#0a0f1e] via-[#111827] to-[#0a1628]">
            ...
            <div className="container mx-auto relative z-10 text-center">
              <AnimatedSection animation="fade-up">
                <Badge className="mb-4 bg-primary/20 text-primary border border-primary/30 text-xs font-bold uppercase tracking-widest px-4 py-1.5">
                  InVision Network — 2026 Roadmap
                </Badge>
                <h1 className="text-2xl md:text-4xl lg:text-4xl font-black text-white mb-4 leading-tight">
                  Autonomous{" "}
          ...
          <section className="py-12 md:py-18 bg-background">
            <div className="container mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-7 items-center max-w-6xl mx-auto">
                {/* visual panel */}
                <AnimatedSection animation="fade-right">
                  <div className="relative rounded-2xl overflow-hidden border border-border bg-[#0d1117] p-4 shadow-2xl">
          ...
          <section className="py-12 md:py-18 bg-background">
            <div className="container mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-7 items-center max-w-6xl mx-auto">
                {/* visual */}
                <AnimatedSection animation="fade-right">
                  <div className="relative rounded-2xl border border-border bg-[#0d1117] p-4 shadow-2xl overflow-hidden">
                    {/* glowing pulse in bg */}
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-9">
                  {[
                    ...
                    <AnimatedSection key={item.title} animation="fade-up">
                      <div className="p-4 rounded-2xl border border-border bg-card hover:border-primary/30 hover:shadow-lg transition-all duration-200 text-center h-full">
                        <div className="w-9 h-9 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-5">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-border bg-muted/50">
                        <th className="text-left px-4 py-4 font-bold text-foreground">Feature</th>
                        <th className="text-left px-4 py-4 font-bold text-foreground">Technology</th>
                        <th className="text-left px-4 py-4 font-bold text-foreground">Your Role</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        >
                          <td className="px-4 py-4 font-semibold text-primary">{row.feature}</td>
                          <td className="px-4 py-4 text-muted-foreground">{row.tech}</td>
                          <td className="px-4 py-4 text-foreground">{row.role}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          {/* CTA */}
          {/* ──────────────────────────────────────────────────────────────────── */}
          <section className="py-12 md:py-18 relative overflow-hidden bg-gradient-to-br from-[#0a0f1e] via-[#111827] to-[#0a1628]">
            <div className="absolute top-0 left-1/3 w-80 h-80 bg-primary/20 rounded-full blur-[100px] pointer-events-none" />
            <div className="container mx-auto relative z-10 text-center">
              <AnimatedSection animation="fade-up">
                <h2 className="text-3xl md:text-3xl font-black text-white mb-4 leading-tight">
                  Ready to become{" "}
                  <span className="gradient-text-fire">
                    un-hackable?
                  </span>
