...
const ROUTES = [
  ...
  // Digital library
  "/library",
  // Resource book detail pages — must match sitemap.xml exactly
  "/resources/ai-fundamentals",
  "/resources/scam-prevention-guide",
  "/resources/family-safety-toolkit",
  "/resources/senior-tech-handbook",
  "/resources/digital-privacy-mastery",
  "/resources/deepfake-detection",
  "/resources/password-security",
  "/resources/social-media-safety",
  "/resources/online-shopping-guide",
  "/resources/identity-theft-prevention",
  "/resources/business-cybersecurity",
  "/resources/ai-management-guide",
  "/resources/being-real-in-ai-world",
  "/resources/auth-of-personalities",
  "/resources/auth-of-friendship-v2",
  "/resources/cyber-awareness-for-kids",
  "/resources/smart-home-security",
  "/resources/email-phishing-defense",
  "/resources/banking-and-financial-safety",
  "/resources/mobile-phone-security",
  "/resources/crypto-scam-defense",
  "/resources/romance-scam-awareness",
  "/resources/voice-clone-detection",
  "/resources/medicare-fraud-protection",
  "/resources/email-safety-essentials",
  "/resources/tax-scam-prevention",
  "/resources/tech-support-fraud-defense",
  "/resources/grandparent-scam-defense",
  "/resources/investment-fraud-guide",
  "/resources/charity-scam-awareness",
  // Legal
  "/privacy-policy",
  "/terms-of-service",
  "/refund-policy",
